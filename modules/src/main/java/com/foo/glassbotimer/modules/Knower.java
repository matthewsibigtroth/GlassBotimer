...
public class Knower
{
    ...
    public Knower(BrainActivity brainActivity)
    {
    ...
    private void OnComplete_findFreebaseNodeDataForInputText(FreebaseNodeData FreebaseNodeData, String inputText) throws IOException
    {
        this.GetBrainActivity().OnComplete_findFreebaseNodeDataForInputText(FreebaseNodeData, inputText);
    }

    private void OnComplete_findRelatedFreebaseNodeDataForInputText(FreebaseNodeData FreebaseNodeData, String inputText) throws IOException
    {
        this.GetBrainActivity().OnComplete_findRelatedFreebaseNodeDataForInputText(FreebaseNodeData, inputText);
    }
            ...
            public void run()
            {
                try
                {
                    ...
                    if (numTopics > 0) {
                        ...
                        FreebaseNodeData FreebaseNodeData = CreateFreebaseNodeDataForTopicDatum(TopicDatum);
                        //OnComplete_findFreebaseNodeDataForInputText(FreebaseNodeData, inputText__);
                        OnComplete_findRelatedFreebaseNodeDataForInputText(FreebaseNodeData, inputText__);
                    }
                } catch (IOException e) {
                    e.printStackTrace();
                } catch (JSONException e) {
